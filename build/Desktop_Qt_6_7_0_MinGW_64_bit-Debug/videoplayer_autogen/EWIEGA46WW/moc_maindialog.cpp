...
constexpr auto qt_meta_stringdata_CLASSMainDialogENDCLASS = QtMocHelpers::stringData(
    ...
    "onDurationChanged",
    "onPostionChanged",
    "on_openFileBt_clicked",
    "on_playBt_clicked",
    "on_suspendBt_clicked",
    "on_stopBt_clicked",
    "resizeEvent",
    "QResizeEvent*",
    "on_muteBt_clicked"
...
Q_CONSTINIT const QMetaObject MainDialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMainDialogENDCLASS_t,
        ...
        // method 'onPostionChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<qint64, std::false_type>,
        // method 'on_openFileBt_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_playBt_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_suspendBt_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_stopBt_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'resizeEvent'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<QResizeEvent *, std::false_type>,
        // method 'on_muteBt_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void MainDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onStateChanged((*reinterpret_cast< std::add_pointer_t<QMediaPlayer::MediaStatus>>(_a[1]))); break;
        case 1: _t->onDurationChanged((*reinterpret_cast< std::add_pointer_t<qint64>>(_a[1]))); break;
        case 2: _t->onPostionChanged((*reinterpret_cast< std::add_pointer_t<qint64>>(_a[1]))); break;
        case 3: _t->on_openFileBt_clicked(); break;
        case 4: _t->on_playBt_clicked(); break;
        case 5: _t->on_suspendBt_clicked(); break;
        case 6: _t->on_stopBt_clicked(); break;
        case 7: _t->resizeEvent((*reinterpret_cast< std::add_pointer_t<QResizeEvent*>>(_a[1]))); break;
        case 8: _t->on_muteBt_clicked(); break;
        default: ;
        }
    }
}
